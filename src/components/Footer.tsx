    ...
    <footer className="bg-white border-t border-gray-200 mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">Portflow.ai</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/templates" className="text-gray-600 text-sm hover:text-primary transition-colors">
                  Templates
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/guides" className="text-gray-600 text-sm hover:text-primary transition-colors">
                  Guides
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Portflow.ai. All rights reserved.
          </p>
